...
*/
#include "0head.cpp"
/* these are functions for char*/
size_t Strlen(const char *s);

char *Strcpy(char *dest, const char *src);
char *Strncpy(char *dest, const char *src, size_t n);
char *Strxcpy(char *dest, const char *src, size_t ss, size_t n);

char *Strcat(char *dest, const char *src);
char *Strncat(char *dest, const char *src, size_t n);
char *Strxcat(char *dest, size_t ds, const char *src, size_t ss, size_t n);

int Strcmp(const char *s, const char *t);
int Strncmp(const char *s, const char *t, size_t n);
int Strxcmp(const char *s, size_t ss, const char *t, size_t ts, size_t n);
...
const char *Strchr(const char *dest, int c);
const char *Strxchr(const char *dest, size_t ds, int c);

const char *Strrchr(const char *dest, int c);
const char *Strxrchr(const char *dest, size_t ds, int c);
...
char *Strxsqz(char *dest, size_t ds, int chr);

char *Strtrim(char *dest);
char *Strxtrim(char *dest, size_t ds);
...
char *Strtolower(char *dest);
char *Strxtolower(char *dest, size_t ds);
