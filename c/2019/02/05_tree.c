...
struct table *tab_seek(struct table *list[], size_t nlist, const char *word)
{
...
struct table *tab_upd(struct table *list[], size_t nlist, const char *word, const char *def)
{
	unsigned h = Hash(word, nlist);
	struct table *p;
