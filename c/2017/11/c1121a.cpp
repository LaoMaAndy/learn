/*
function: stringcmp, stringsch, stringvec, vsswap, vsqksort, vssort
*/
#include "0head.cpp"

int stringcmp(const string &s, const string &t)
{
	decltype(string[0]) a, b;
	decltype(string.size()) ss, ts, i;
...
size_t stringsch(const string &s, const vector<string> &v)
{
	size_t low = 0;
	size_t high = v.size();
