/*
 * prototype. 3 method of sort: quick-sort, shell sort, bubble sort
 */
 ...
 * Main function
 */
#define PRN_CAL(func) printf("Testing function :"#func"\n");func

int main(int argc, char *argv[])
{
	PRN_CAL(test_sort(qksort));
	PRN_CAL(test_sort(shsort));
	PRN_CAL(test_sort(bbsort));
