/*
function: wordcount, keyword, tree, table
*/
#define NEED_FILE
#include "0head.c"
...
void file_key(FILE *fp, char *key[], int n)
{
	char buf[200];
...
struct table *tabseek(struct table *list[], int n, char *word)
{
	struct table *p;
...
struct table *tabupd(struct table *list[], int n, char *word, char *def)
{
	struct table *p;
