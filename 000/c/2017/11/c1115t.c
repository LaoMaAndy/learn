/*
function: wordcount, key word, tree, table
*/
#define NEED_FILE
#include "0head.c"
...
int tabupd(struct table *list[], int n, char *word, char *def)
{
	struct table *p;
...
void file_table(FILE *fp)
{
	...
	int tsize = sizeof(list) / sizeof(*list);
	int i;
